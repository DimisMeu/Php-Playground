<?php
//For www.ikteo-istiaias.gr
$vin = $_POST["VINumber"];
echo "Πλαίσιο: <b class='red'>".$vin. "</b>";
echo "<br />";
...
class VIN {
	...
	public static function decode($a){
		...
		echo "Ήπειρος: <b>" .$data['continent']. "</b>";
		echo "<br />";
		echo "Χώρα προέλευσης: <b>" .$data['country']. "</b>";
		echo "<br />";
		echo "Κατασκευαστής: <b class='red'>" .$data['make']. "</b>";
		echo "<br />";
		echo "Έτος Κατασκευής: <b>" .$data['year']. "</b>";
		echo "<br />";
		return $data;
	}
}

//$vin = "WAUZZZ8P79A124954"; -1
VIN::decode($vin);
